...
- **Remove dashboard header page** — eliminate the landing/header page shown on first dashboard load
- **Redesign book cards in Your Library**
...
- **Split Library into TBR and Completed** — break the single library section into distinct TBR and Completed subsections
