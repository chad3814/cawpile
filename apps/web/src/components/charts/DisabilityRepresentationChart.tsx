...
interface DisabilityRepresentationChartProps {
  year: number;
}
...
export function DisabilityRepresentationChart({ year }: DisabilityRepresentationChartProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(`/api/charts/disability-representation?year=${year}`);
