...
interface AcquisitionMethodChartProps {
  year: number;
}
...
export function AcquisitionMethodChart({ year }: AcquisitionMethodChartProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(`/api/charts/acquisition-method?year=${year}`);
